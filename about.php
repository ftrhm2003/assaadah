...
.section__container {
  ...
  margin: auto;
  padding-top: 0rem; /* Hanya padding atas dikurangi */
  padding-right: 1rem;
  padding-bottom: 5rem;
  padding-left: 1rem;
}
...
<section class="quote">
        <div class="layar-dalam">
            <p>Belajar tanpa berpikir itu tidak berguna, tapi berpikir tanpa belajar itu sangat berbahaya</p>
        </div>
</section>
