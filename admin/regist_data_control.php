...
if (isset($_GET['action']) && $_GET['action'] == "hapus") {
    ...
    if (mysqli_num_rows($query_pendaftar)) {
        ...
        // Hapus nilai
        $sql_hapus_pendaftarinside = mysqli_query($koneksi, "DELETE FROM pendaftarinside WHERE pendaftar_id = '$id_pendaftar'");
        ...
        if ($sql_hapus_pendaftarinside && $sql_hapus_pendaftar && $sql_hapus_user) {
